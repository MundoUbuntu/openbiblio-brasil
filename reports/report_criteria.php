 ...
 */
  ...
  Nav::node('reportcriteria', 'Critérios de Relatório');
...
<?php
  $format = array(
    array('select', '__format', array('title'=>'Format'), array(
      array('paged', array('title'=>'HTML (pagina por pagina)')),
      array('html', array('title'=>'HTML (unica grande pagina)')),
      array('csv', array('title'=>'CSV (valores separados por virgulas)')),
    )),
  );
